      ...
      >
        <div className="max-w-xl mx-auto w-full flex flex-col gap-6 md:gap-8">
            ...
            <div className="flex flex-col items-center justify-center pt-4 w-full gap-3">
                ...
                <button 
                    onClick={onMoreClick}
                    className="w-full py-4 bg-white/5 backdrop-blur-md border border-white/10 text-white text-sm font-bold rounded-xl hover:bg-white/10 transition-all flex items-center justify-center gap-2 shadow-lg active:scale-[0.98]"
                >
                    공연 정보 확인하기
                </button>

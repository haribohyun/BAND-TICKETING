        ...
        <div className="flex flex-col items-center gap-4 transform -translate-y-24 md:-translate-y-20 pointer-events-auto">
            ...
            <div className="flex flex-col items-center justify-end gap-1 mb-2">
                <div className="flex flex-col items-center gap-1">
                    <p className="text-[10px] md:text-xs font-medium tracking-widest text-[#D8B4FE]">
                        밸런타인데이 저녁
                    </p>
                    <p className="text-[10px] md:text-xs font-medium tracking-widest text-[#D8B4FE]">
                        초콜릿 공장에 당신을 초대합니다!
            ...
            <div className="relative flex flex-col items-center justify-center">
                <img 
                    src="https://i.postimg.cc/pVDbsK2w/Gemini-Generated-Image-xqf6mjxqf6mjxqf6-removebg-preview.png"
                    alt="Main Visual"
